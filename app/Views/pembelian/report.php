                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div>
                                ...
                                <a target="_blank" class="btn btn-primary mb-3" type="button" href="<?= base_url('beli/exportexcel') ?>">EXPORT EXCEL</a>
                            </div>
                        </div>
                    </div>
                </form>
                    ...
                    <tbody>
                        ...
                        foreach ($result as $value) : ?>
                            <tr>
                                ...
                                <td><a target="_blank" class="btn btn-danger mb-3" type="button" href="<?= base_url('beli/invoicepdf') ?>/<?= $value['buy_id'] ?>">Detail</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
